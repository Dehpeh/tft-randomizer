...
(function (root, factory) {
  ...
  const MINOR = [
    ...
    { id: 'mn-carousel',  family: 'carousel', text: 'Carousel pick banned for 2 stages', details: [{ label: 'Stages', options: ['stages 2 and 3', 'stages 3 and 4', 'stages 4 and 5', 'stages 5 and 6'] }] },
