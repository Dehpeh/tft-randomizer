/* Reading the numbers TFT prints on the screen.
   ...
   sample, and gold read 26 values correctly, 0 wrongly, 1 not at all, with all
   9 frames that showed no gold correctly returning nothing. Never inventing a
   number is the property that matters — a wrong stage would put a note on the
   wrong round.
