...
(function (root, factory) {
  ...
  function run(log) {
    ...
    is('an econ threshold is silent without the econ rule',
      play([], [{ kind: 'match-open', at: 10, matcher: 'gold-threshold', label: 'g', stage: 3, round: 1 }]).length, 0);
    has('and speaks with it',
      play([{ id: 'mn-econ', details: [] }], [{ kind: 'match-open', at: 10, matcher: 'gold-threshold', label: 'g', stage: 3, round: 1 }]),
      'round number');
